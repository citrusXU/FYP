...
# class RandomSizedSquareCrop(object):
...
#         # Fallback
#         scale = RectScale(self.width, self.height, 
#                           interpolation=self.interpolation)
#         return scale(img)


class RandomSizedRectCrop(object):
    def __init__(self, height, width, interpolation=Image.BILINEAR, ratio=(2, 3)):
        self.height = height
        self.width = width
        self.interpolation = interpolation
        self.ratio = ratio
